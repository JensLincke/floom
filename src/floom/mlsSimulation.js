...
System.prototype.__particleToGrid = function() {
	...
	_.each(this.particles, function(p, particleIndex) {
		...
		this.integrator.integrate(p, function(particle, node, phi, gxpy, pxgy){
			...
			const cellToParticle = new Matrix([[gxpy, pxgy]]);
			const Q =  Vector2.fromMatrix(cellToParticle.mmul(particle.affineMomentum));
